...
public class CenterTargetAutonRightTask extends TurnToFaceVisionTargetTask {
    ...
    protected void runVisionTask() {
    	...
    	Robot.motors.rightDrive.set(-Robot.prefs.getDouble("dead_reckoning_center_turn_speed", 0));
    	wait.forSeconds(Robot.prefs.getDouble("dead_reckoning_center_turn_time", 0));
    	...
    	Robot.motors.leftDrive.set(-Robot.prefs.getDouble("dead_reckoning_center_right_turn_speed", 0));
